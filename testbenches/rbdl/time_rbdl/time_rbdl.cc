...
#include <include/gemmini_declarations.h>
#include <stdint.h>
...
int main (int argc, char* argv[]) {
    ...
    std::cout << "Total RNEA Cycles: " << end-start<< std::endl;
    ...
    asm volatile ("rdcycle %0" : "=r" (end));
    std::cout << "Total CRBA Cycles: " << end-start<< std::endl;
    ...
    asm volatile ("rdcycle %0" : "=r" (end));
    std::cout << "Total ABA Cycles: " << end-start<< std::endl;
    ...
    std::cout << "Total matmul cycles: " << total_time << std::endl;
